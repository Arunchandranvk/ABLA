"""
Django settings for ABLA project.
...
SECRET_KEY = 'django-insecure--=%ekfxqo3=g0(h1#)qd6_+w1#q@ql7#mykutip)t1%)-&h+i$'
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "ABLA_Logo.PNG",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "ABLA_Logo.PNG",
...
# Simple JWT settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=180),  # Adjust token lifetime as needed
...
WSGI_APPLICATION = 'ABLA.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'ypwynccwqbesmjlh'


DEFAULT_FROM_EMAIL = 'demoarun4@example.com'
